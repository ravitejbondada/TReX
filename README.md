...
- **Add Expense mobile layout:** Date and note share one compact row on phones, with the date field given a protected minimum width so the save button sits above the bottom nav more reliably.
