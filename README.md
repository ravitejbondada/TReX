...
- **Recurring entry point:** Recurring schedules are managed from the sidebar/drawer. Add Expense includes a subtle top-right recurring action for users who realize an expense should become a schedule.
